...
var _Reward = _interopRequireDefault(require("../../../../rewards/infra/typeorm/entities/Reward"));
...
let TransactionsRewards = (_dec = (0, _typeorm.Entity)('transactions_rewards'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = Reflect.metadata("design:type", String), _dec4 = (0, _typeorm.OneToOne)(() => _User.default, {
  eager: true
}), _dec5 = (0, _typeorm.JoinColumn)({
  name: 'user_id'
}), _dec6 = Reflect.metadata("design:type", typeof _User.default === "undefined" ? Object : _User.default), _dec7 = (0, _typeorm.OneToOne)(() => _Reward.default, {
  eager: true
}), _dec8 = (0, _typeorm.JoinColumn)({
  name: 'reward_id'
}), _dec9 = Reflect.metadata("design:type", typeof _Reward.default === "undefined" ? Object : _Reward.default), _dec10 = (0, _typeorm.Column)(), _dec11 = Reflect.metadata("design:type", String), _dec12 = (0, _typeorm.Column)(), _dec13 = Reflect.metadata("design:type", String), _dec14 = (0, _typeorm.Column)(), _dec15 = Reflect.metadata("design:type", Number), _dec16 = (0, _typeorm.CreateDateColumn)(), _dec17 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec18 = (0, _typeorm.UpdateDateColumn)(), _dec19 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = (_class2 = (_temp = class TransactionsRewards {
  constructor() {
    ...
    _initializerDefineProperty(this, "reward_id", _descriptor5, this);
  ...
  writable: true,
  initializer: null
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "reward", [_dec7, _dec8, _dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "user_id", [_dec10, _dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "reward_id", [_dec12, _dec13], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "score", [_dec14, _dec15], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
...
var _default = TransactionsRewards;
